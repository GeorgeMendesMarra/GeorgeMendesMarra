# 📘 Avaliação – Computadores a Válvulas

---

## 🟢 Parte I – Questões Objetivas (1–10)

**1.** Os computadores a válvulas pertencem a qual geração da computação?
...
**3.** Uma válvula termiônica funciona como:
...
d) Unidade de armazenamento óptico

---

**4.** O ENIAC utilizava aproximadamente:
...
**5.** O Colossus foi utilizado principalmente para:
...
**6.** O EDVAC ficou conhecido por introduzir:
...
**7.** As ideias de programa armazenado estão associadas a:
...
**8.** Uma desvantagem dos computadores a válvulas era:
...
**9.** O tamanho físico desses computadores era:
...
**10.** O declínio dos computadores a válvulas ocorreu devido à invenção:
