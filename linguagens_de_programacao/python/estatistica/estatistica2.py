...
# Gera um gráfico de pizza (pie chart)
# autopct: formata a exibição da porcentagem dentro da fatia
# startangle: rotaciona o início do gráfico para melhor estética
plt.pie(casos, labels=anos, autopct='%1.1f%%', startangle=90)

# Garante que o gráfico de pizza seja desenhado como um círculo perfeito
plt.axis('equal')
