...
O projeto será avaliado em **duas entregas**, correspondentes a fases distintas do desenvolvimento. Diferente da estrutura anterior, a primeira entrega agora é restrita a **HTML + CSS**, e o Bootstrap passa a ser exigido junto com JavaScript e jQuery na segunda entrega.

---

### 6.1 Primeira Entrega (N1) — 02/10/2026

**Foco:** Estrutura e estilização estática de uma landing page (HTML + CSS puro, sem framework).

**Itens obrigatórios nesta etapa:**

- Pelo menos **uma landing page completa** em HTML5 semântico (`header`, `nav`, `main`, `section`, `footer`);
- Estilização completa com **CSS próprio** — sem uso de Bootstrap ou outro framework CSS nesta fase;
- Layout construído com Flexbox e/ou Grid;
- Site responsivo, testado em pelo menos 3 resoluções (desktop, tablet, mobile), usando media queries;
...
### 6.2 Segunda Entrega (N2) — 04/12/2026

**Foco:** Interatividade, framework CSS e finalização do projeto (JavaScript + jQuery + Bootstrap).

**Itens obrigatórios nesta etapa:**

- Aplicação do **Bootstrap** no layout (grid responsivo, componentes como navbar, cards, botões, modais, etc.), integrado ao CSS próprio já existente;
...
- Expansão do site para no mínimo 3 páginas, se ainda não tiver sido feito na primeira entrega;
...
| ---------------- | -------------------------------------------------------------- | --------------- |
| 1ª Entrega (N1)  | HTML + CSS (landing page estática e responsiva, sem framework) | **02/10/2026**  |
| 2ª Entrega (N2)  | JavaScript + jQuery + Bootstrap (interatividade e finalização) | **04/12/2026**  |
...
*Centro Universitário Alves Faria — UniAlfa*
*Curso de Análise e Desenvolvimento de Sistemas — Disciplina de Programação Web I*
*Professor: George Mendes Marra*
